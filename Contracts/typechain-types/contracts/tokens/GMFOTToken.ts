...
export interface GMFOTTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "allowance"
...
export interface GMFOTToken extends BaseContract {
  connect(runner?: ContractRunner | null): GMFOTToken;
  waitForDeployment(): Promise<this>;

  interface: GMFOTTokenInterface;
  ...
  getNetSupply: TypedContractMethod<[], [bigint], "view">;
